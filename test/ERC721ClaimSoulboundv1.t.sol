...
import "./ERC721SetUpv1.t.sol";
import "@openzeppelin/contracts/token/ERC721/IERC721.sol";

contract ERC721ClaimSoulboundTest is Test, ERC721SetUp {
    ...
    function testCannotTransferToken() public {
        ...
        vm.expectRevert('ERC721Creator: Extension approval failure');
        creatorContract.transferFrom(address(minter), address(minter2), 1);
    }
